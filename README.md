...
This repository is an example of how to gather project requirements and translate them into a well architected iOS app.

## Feature: Image Feed

### Story: The user wants to view their feed

### Narrative 1

```
As a user with an internet connection
The app should show the most recent posts in my feed
So I can enjoy content from people I follow
```
...
When they request to see their feed
The app should display the latest feed from remote
...
```
As a user with no internet connection
The app should display the latest retrieved/saved version of my image feed
So I can always enjoy posts from people I follow
```
